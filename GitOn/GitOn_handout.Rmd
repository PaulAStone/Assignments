...
Last, Enterprise versions of Github do not help us meet the requirements of many journals and funding agencies that our data and code be freely available.
...
Save this blank file as `QBTools.R`
...
When you initialized your new repo, you created a blank README.md file.
Take a moment to modify this README file to include the information needed for your QBTools repo.
You can open this file in RStudio to make changes.
There is an example README.md file in the GitOn directory of your QB_2015 repo that you should use as a template.
Before moving on, save the modified `README.md` file in your new repo. 
In a terminal window, add and commit the file using git.
