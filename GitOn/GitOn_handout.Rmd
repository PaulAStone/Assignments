...
Although effective for teaching and development, there are a few downsides to using Enterprise versions of Github. 
...
After modifying the files on your local computer, you saved and commited the changes, which were then pushed to your origin (e.g., QB2015_Smith). 
