...
We will obtain a license from a github.com hosted cite (http://choosealicense.com).
This cite has been setup to allow users to quickly learn about and choose a license.
...
github.com offers a broad selection of licenses for code that range from short and tidy (the MIT license) to the thorough and lengthy (General Public License V3).
These can be easily added with the click of a button.