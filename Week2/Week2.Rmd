...
First, and next to "RAD models", we see "family poisson".
This tells us that by default, vegan assumes Poisson distributed error terms.
...
**But, what should we conclude from this curve fitting exercise?**
