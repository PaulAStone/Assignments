...
The dataset comes from the censusing the trees in 50 one-hectare plots every several years. 
...
Site1 may contain up to 225 species (columns). 
It is important to note that site-by-species matrices also accounts for absences (i.e., zero occurences). 
Let's find out how many species actually occupied Site1 when it was censused (i.e., **species richness**):
...
However, there is more to ($\alpha$) diversity than just the number of species in a plot. 
