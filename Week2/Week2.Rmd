...
Now we know the recorded species richness and recorded total abundance (usually denoted as *N*) of Site1 in the BCI site-by-species matrix. *N* and *S* are two of the most common pieces of data we obtain when sampling ecological communities and assemblages. Finally, we are beginning to quantify our data! But not stopping there, the next natural step in exploring aspects of local diversity is simply to ask how abundance varies among species. One of the most common ways to visually explore this relationship, commonly known as the **species abundance distribution** is simply to rank the species from greatest to least, that is, as a **rank-abundance curve (RAC)**.
