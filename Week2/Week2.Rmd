...
### Not if you can simplify your code; functions are rarely coded as efficiently as they could be. -Ken
...
### Loops are too rudimentary a skill and this function is too complicated to stop inside of and say, "oh BTW, while you're thinking about estimating richness we're going to teach you a new control structure" -Ken
...
### Maybe do Chao1 and Chao2 in class. Then, for homework, give a short explanation of ACE and then say, "Using the example provided, code up the ACE estimator and estimate species richness for ..." -Ken
