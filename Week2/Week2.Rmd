...
```{r, results = 'hide'}
#install.packages("vegan") --> need to make this clear in the Directions at top. 
require("vegan") 
```
...
For example, is invertebrate species richness in a contaminated stream reach different from invertebrate species richness in an undisturbed upstream habitat? 
