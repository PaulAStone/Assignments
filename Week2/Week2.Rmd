...
## INSTALL PACKAGES
People develop different packages for certain tasks that can be carried out in the R enviornment. Use the 'help'funciton to learn about package installation and add-ons. Throughout this course, we will use the R package called vegan, which is 
...
In the vegan library, there is a data set that we will be using called BCI. BCI stands for Barro Colorado Island, which is an island located in the center of the Panama canal. The BCI data frame has 50 plots (rows) of 1 hectare with counts of trees on each plot with total of 225 species (columns)
