...
4. Be sure to answer the questions in this exercise document; they correspond to the handout.
Space for your answer is provided in this document and indicated by the ">" character.
If you need a second paragraph, then be sure to start the first line with ">".
You should notice that the answer is highlighted in green by RStudio.
5. Before you leave class, it is *imperative* that you **push** this file to your GitHub repo.
...
In the following R chunk, load this microbial dataset as a matrix and then identify a sample (i.e., site) for subsequent analysis.
