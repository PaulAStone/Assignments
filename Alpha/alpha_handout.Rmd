...
One index that provides an estimate of how well a site is sampled is known as **Good's Coverage (C) where** $C = 1 - \frac{n_{1}}{N}$, **$n_{1}&** is the number of **singleton species** (species only detected once), and \textbf{N} is the total number of individuals in the sample.
...
d.  What would we conclude from Good's Coverage if **$n_{1}$** equaled \textbf{N}?
