...
lake <- ifelse(grepl("WG",row.names(tradeoff)),'WG', 'LL') # make an empty vector for lake id
...
plot(LL.nb, log1p(LL.umax), axes = F, xlab = "Niche Breadth", ylab = "Maximum Growth Rate", 
  pch = 21, cex = 2, las = 1, col = "black", bg = "white",
  xlim=c(0,1), ylim = c(0, 1))

  points(WG.nb,log1p(WG.umax),pch=21,cex=2,col="black", bg="black")
  box()
  axis(side = 1, labels=T, cex.axis = 1.25)
  axis(side = 2, las = 1, cex.axis = 1.25, labels = c(0.1, 1, 10), at = log1p(c(0.1, 1, 10)))
