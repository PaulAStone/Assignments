...
In the R code chunk below, do the following:  
1. make a second distance matrix based on the Fellenstein 84 substitution model,  
2. create a saturation plot to compare the *raw* and *Fellenstein (F84)* substitution models,  
...
2. make a saturation plot that compares that model to the *Fellenstein (F84)* model,  
