...
## 2) LOADING DATA
We will be analyzing data from a survey of shallow ponds east of Bloomington, Indiana that are scattered throughout Brown County State Park, Yellowwood State Forest, and Hoosier National Forest. 
In the 1940s, Maury Reeves of the Indiana Department of Natural Resources started making ponds with a small dozer in an effort to create a refuge for deer and turkeys. 
In the summer of 2013, we visited approximately 50 of these "refuge" ponds and used GPS to record their geographic location. 
In addition, the ponds were sampled for water chemistry, phsyical properties, and bacterial community composition. 

![pond](/Users/lennonj/Desktop/data/pond.JPG)
