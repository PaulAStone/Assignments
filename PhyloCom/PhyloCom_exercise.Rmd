...
7. load the taxonomic data using the `read.tax()` function.
...
2. pick another null model and compare the results to the `richness` randomization output . 

### MEM: confused about above request and question below...?
```{r}
...
```
#### MEM: I sort of find 1 and 2 below confusing???
