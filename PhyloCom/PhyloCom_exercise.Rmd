...
In the R code chunk below, do the following:
1. calculat the phylogenetic resemblance matrix for taxa in the Brown County ponds.
...
In the R code chunk below, do the following:
1. test the hypothesis that watersed effects the phylogenetic diversity of bacteiral communities.
...
In the R code chunk below, do the following:
1. define the environmental variables of interest, and  
2. calcuate the distance between sites based on these variables.
...
In the R code chunk below, do the following:
1. conduct a Mantel's test to test whether UniFrac distance is correlated with environmental varaition.
...
In the R code chunk below, do the following:  
1. calculat the geographic distances among ponds,  
2. calculat the taxanomic similarity amoung ponds, 
3. calculat the phylogeneti similarity amoung ponds, and  
...
In the R code chunk below, do the following:  
1. test if the trend lines in the above distance decay relationships are different.
...
3. calculate the Pearson's and Spearman's correlations coefficients,   
4. plot the PDAR and include the correlations coefficients in the legend, and  
