...
spatial  :  aggregate randomly or with respect to distance;  values are TRUE or FALSE; use FALSE as the default
PD.index  :   phylogenetic diversity index; use 'PSV', 'NRI', 'NDI'
