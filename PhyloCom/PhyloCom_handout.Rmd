...
# Need to figure out how to add an outgroup for rooting.
...
```{r}
# This plots samples onto the tree
# Labels (rownames) just correspond to "mock" samples, which demonstrate different patterns of dispersion
# "includes only species present in a community data set"
# Depending on number of OTUs in our samples, this could look ugly. 

# Prune a phylogenetic tree to include only species present or that have non-missing trait data
prunedphy <- prune.sample(com, jc.tree)
