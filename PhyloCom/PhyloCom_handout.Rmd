...
ses.pd <- ses.pd(comm, phy, null.model = "taxa.labels", runs = 10, iterations = 2, include.root = FALSE)
```
...
ses.mpd <- ses.mpd(comm, phydist, null.model = "taxa.labels", abundance.weighted = FALSE, runs = 10)
