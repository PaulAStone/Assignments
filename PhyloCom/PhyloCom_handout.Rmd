...
# It' not clear that we will need the `prune.sample` function 
...
These null models can control for features usch as species richness, species occurrence frequencey, the diversity of the regional species pool. 
