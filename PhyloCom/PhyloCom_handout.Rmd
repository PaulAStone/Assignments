...
phy <- drop.tip(phy.all, phy.all$tip.label[!phy.all$tip.label %in% colnames(comm)])
...
plot(pd$SR, pd$PD, 
     pch = 20, col = "red", las = 1, xlim = c(0, 800), ylim = c(0, 100),
...
ses.pd <- ses.pd(comm, phy, null.model = "taxa.labels", runs = 100, iterations = 99)
```
