...
plot(geo.dist, bray.curtis, xlab = "", xaxt = "n", las = 1,
...
plot(geo.dist, unifrac, xlab="", 
     ylab="Unifrac Similarity", col='darkorchid4', las = 1)

DD.reg.uni <- lm(unifrac ~ geo.dist)
abline(DD.reg.uni, col="red4")

mtext("Geographic Distance (degree distance)", side = 1, adj = 0.65, 
      line = 0.5, outer = TRUE)
```
