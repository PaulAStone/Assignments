...
##HOMEWORK
1) Complete the entire exercise in the Week1_R.Rmd
...
3) Use knitr to create a pdf of your completed Weed1_R.rmd document, push it to GitHub, and create a pull request.
