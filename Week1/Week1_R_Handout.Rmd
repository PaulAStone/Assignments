...
2) Redo the linear regression and ANOVA with log10-transformed zooplankton biomass data (often, log-transformations help with meeting assumptions of normality and equal variance). Do you think this is a better analysis? ###provide some space to answer?###
