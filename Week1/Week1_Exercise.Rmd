...
This exercise introduces some of the basic features of the R computing environment (http://www.r-project.org).
This exercise is to be used along side your Week 1 Handout. 
You will not be able to complete this if you do not have your handout.

## Directions:
1. Change **Student Name** above (line 3) with your name.
2. Please complete as much of this as possible during class; what you do not complete in class will need to be done on your own outside of class.
3. Use the handout as a guide; it contains a more complete description of data sets along with the proper scripting needed to carry out the exercise.
4. Be sure to answer the questions in the handout in this document.
Space for your answer is provided in this document and indicated by the ">" character.
If you need a second paragraph be sure to start the first line with ">".
You should notice that the answer is highlighted green by RStudio. 
...
Basically, just press the `Knit` button above the scripting panel.
8. After Knitting, please submit by creating a **pull request** via GitHub. 
...
When you are done, you can *knit* your document together.
...
Even if you are able to knit without issue, please me sure to review your PDF before submitting.
...
5) Finally, show "b"" again to demonstrate that R did not update "b" when "a" was changed (i.e., R is not a symbolic programming language).
...
In the R code chunk below, do the following:
Using a mixture of Approach 1 and 2, create a matrix, "n", with two columns and 5 rows.
...
3) Include error bars on your plot and label the axis appropriately.
...
2) In addition, redo the section on linear regression (including summary statistics, plotting, and diagnostics) using log10-transformed zooplankton biomas. Provide the code in the following code block:
...
***Homework Question***: Does the transformation help meet assumption of linear regression or change the interpretation of the analysis in anyway? Describe.
