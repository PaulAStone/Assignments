...
***What files do they need to submit a pull request for? The Rmd and knitted PDF? We should be clear!***
...
There are two major feature to this document: 1) Markdown formatted text 2) "chunks" of R code.
...
You can also type code directly into the Console pane. 
...
Even if you are able to knit without issue, it is good practice to review your PDF before submitting.

## 2) SETTING YOUR WORKING DIRECTORY
***Can the following bullets be formatted like "Directions" above, when printed, just text wrapping***
...
```
***Can the following bullets be formatted like "Directions", when printed, just text wrapping***
***Not sure about the trig-twister in 3 below***
...
2) Create a new vector `w` by multiplying `x` by 12 (i.e., "scalar").
...
2) In addition, redo the section on linear regression (including summary statistics, plotting, and diagnostics) using log10-transformed zooplankton biomas. Provide the script in the following code block:
