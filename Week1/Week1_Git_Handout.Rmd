...
## Version control 
One of the riskiest things you can do with your data, manuscripts, and computing code is to lose track of various versions. While naming your files  "Dissertation-v43-partA-AdvisorsComments-Rejected.txt, ProjectChangeTheWorld-v23.csv, or Project-Change-The-World-v23.csv". 

Version control is an approach to writing text, managing data, and developing computer code that allows users the ability to examine, comment on, and revert back to changes within the entire life of a document.
