...
Quantitative Biodiveristy required that you install certain software on your personal computers, including R, RStudio, Git, and LaTeX.
...
We will install the latest version of R (v 3.1.2; "Pumpkin Helmet"") using the following insructions:
...
**Mac users please read**:
    ...
    You can download XQuartz v2.7.7 from the following site:http://xquartz.macosforge.org/landing/
...
***should we specify what a "current version" means? most up-to-date/***
...
4. Open the installer and follow the onscreen directions.
  ...
  **On Mac**: You will need to make sure you have Xcode Command Line Tools installed.  
  ###Will this be inutitive? How should student confirm? If not, how do they install?###
  **On Windows**: This process ### what proces???## will install Git Bash (msysGit). 
  ...
  ###Some of the Windows stuff is unclear for me. ###
...
If you do not have a current RStudio version installed on your computer (v 0.98 +), please do the following:
