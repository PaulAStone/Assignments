...
###Identifying and visualizing influential species in PCoA 
Basic ordination plots allow us to see how samples separate from one another. 
It is logical to ask what features of the data set are driving the observed divergence of points. 
...
A more quantitative way of identifying influential species involves determining the correlation of each species along each PCoA axis. 
...
a.  Generate a hypothesis about which fish species are potential indicators of river quality.
b.  Do the different approaches described in the ordination section agree or disagree? Explain. 
...
The visualization tools that we just learned about are powerful for exploring data sets and *generating* hypotheses. 
