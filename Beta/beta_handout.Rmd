...
PCoA starts with creating a matrix A which is a transformed and centered version of a distance matrix D. These steps preserve all distances, therefore, 


is a robust ordination technique that can be used on any distance matrix.
