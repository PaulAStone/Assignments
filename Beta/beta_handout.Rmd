...
This is because they lead to the **Species Abundance Paradox**, whih is a phenomenon that occurs when the distance between two sites that have no species in common is smaller than the distance between sites with shared species.
