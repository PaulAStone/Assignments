...
###ii. Creating a PCoA ordination plot 
...
###iii. Identifying and visualizing influential species in PCoA 
...
The visualization tools that we just learned about (ie., heatmaps, cluser analysis, and ordination) are powerful for exploring data sets and *generating* hypotheses. 
...
Though the Doubs River is not a controlled experimental system, let's test the hypothesis that fish community composition is affected by river quality rankings.
